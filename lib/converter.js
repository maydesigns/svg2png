...
var HTML_PREFIX = "<!DOCTYPE html><style>html, body { margin: 0; padding: 0; background-color: white; } " +
...
function convert(options) {
    ...
    // Handle http error codes while receiving content.
    ...
    // Handle failure to receive some content.
    page.onResourceTimeout = function (response) {
      console.error("Timeout during retrieval of " + response.url);
      phantom.exit()
      return;
    }

    // Handle errors while receiving content.
